...
import createCase from '@salesforce/apex/PresciberWorkspaceLWCController.cloneCase';
...
export default class PrescriberApplicationStepOne extends NavigationMixin(LightningElement) {
    ...
    connectedCallback(){
        ...
        if(this.caseId != undefined && this.caseRecord == undefined){
    ...
    createContact(actionType){
        ...
        if(actionType == 'onSaveAndComplete'){
            ...
            actionStep = 'Prescriber Re-Enrollment Step One';
        }else if(actionType == 'onNext'){
            if(this.navigateToNext == true){
                action = 'next';
                actionStep = 'Prescriber Re-Enrollment Step Two';
            }else{
                action = 'Save and Complete Later';
                actionStep = 'Prescriber Re-Enrollment Step One';    
            }
